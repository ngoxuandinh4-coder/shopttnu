...
class ProductAdmin(admin.ModelAdmin):
    ...
    list_display = ('image_tag', 'name', 'price', 'stock', 'flash_sale', 'discount_percent')
    list_filter = ['category', 'sizes']
    search_fields = ['name']
    list_editable = ('stock', 'flash_sale', 'discount_percent')
...
class StockReceiptAdmin(admin.ModelAdmin):
    list_display = ['product', 'quantity', 'date_added', 'note']
